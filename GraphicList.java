...
public class GraphicList< E , R extends JComponent > extends JPanel {
	...
	/**
	 * @return				a list of all data stored in this list
	 */
	public ArrayList< E > getData() {
		ArrayList< E > rtn = new ArrayList< E >();
		for ( int i=0 ; i<this.m_list.size() ; i++ ) {
			rtn.add( this.m_list.get( i ).getData() );
		}
		return rtn;
	}
	...
	/**
	 * @param index
	 * @return				graphics associated with the element at the specified index
	 */
	 ...
	 *
	 * @param data
	 * @return				graphics associated with the given data element
	 * 						or null if the data element was not found in the list
	 */
	public R getGraphics( E data ) {
